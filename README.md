...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/Ruclua99/Surveillance-Station/main/9.2.0_11289/SurveillanceStation-x86_64/install_license)
```
...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/Ruclua99/Surveillance-Station/main/9.2.0_11289/license/remove_license)
```
---
### Cracked
